...
#define Depression 1
// 2 x 3
const uint8_t BumpAndDepressionAssets[2][6] = { { 0x1f, 0x00, 0x71, 0x80, 0xc0,
		0xc0, }, { 0xc0, 0xc0, 0x63, 0x80, 0x3e, 0x00, } };

// 1 x 1
const uint8_t DirtTextureAssets[6][1] = { { 0x80, }, { 0xc0, }, { 0xe0, }, { 0xf0, },
		{ 0xf8, }, { 0xfc, } };
